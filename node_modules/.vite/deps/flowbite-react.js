...
var useThemeMode = (usePreferences) => {
  ...
  if (usePreferences) {
    (0, import_react.useEffect)(() => setModeState(getPreference()), []);
    (0, import_react.useEffect)(() => setMode(mode), [mode]);
  }
...
var AccordionComponent = ({ alwaysOpen = false, arrowIcon = HiChevronDown, children, flush = false, className, ...props }) => {
  const [isOpen, setOpen] = (0, import_react4.useState)(0);
...
var BreadcrumbItem = (0, import_react6.forwardRef)(({ children, className, href, icon: Icon, ...props }, ref) => {
...
// node_modules/flowbite-react/lib/esm/components/Button/Button.js
var ButtonComponent = (0, import_react8.forwardRef)(({ children, color = "info", disabled = false, gradientDuoTone, gradientMonochrome, href, label, outline = false, pill = false, fullSized, positionInGroup = "none", size: size2 = "md", className, ...props }, ref) => {
  var _a;
  const isLink = typeof href !== "undefined";
...
var DropdownComponent = ({ children, className, dismissOnClick = true, ...props }) => {
  ...
  const [closeRequestKey, setCloseRequestKey] = (0, import_react15.useState)(void 0);
  const attachCloseListener = (node) => {
    ...
    if (node.props.children && typeof node.props.children === "object") {
      return import_react15.default.cloneElement(node, {
        children: import_react15.Children.map(node.props.children, attachCloseListener)
      });
    }
    return node;
  };
  const content = (0, import_react15.useMemo)(() => (0, import_jsx_runtime23.jsx)("ul", { className: theme2.content, children: import_react15.Children.map(children, attachCloseListener) }), [children, theme2]);
...
var Checkbox = (0, import_react16.forwardRef)(({ className, ...props }, ref) => {
...
// node_modules/flowbite-react/lib/esm/components/FormControls/FileInput/FileInput.js
var FileInput = (0, import_react17.forwardRef)(({ sizing = "md", helperText, color = "gray", className, ...props }, ref) => {
...
var Radio = (0, import_react18.forwardRef)(({ className, ...props }, ref) => {
...
var Select = (0, import_react19.forwardRef)(({ children, sizing = "md", shadow, helperText, addon, icon: Icon, color = "gray", className, ...props }, ref) => {
...
var Textarea = (0, import_react20.forwardRef)(({ shadow, helperText, color = "gray", className, ...props }, ref) => {
...
var TextInput = (0, import_react21.forwardRef)(({ sizing = "md", shadow, helperText, addon, icon: Icon, color = "gray", className, ...props }, ref) => {
...
var ModalComponent = ({ children, show, root, popup, size: size2 = "2xl", position = "center", onClose, className, ...props }) => {
  const [parent, setParent] = (0, import_react24.useState)(root);
  const [container, setContainer] = (0, import_react24.useState)();
...
var SidebarItem = (0, import_react32.forwardRef)(({ as: Component = "a", children, icon: Icon, active: isActive, label, labelColor = "info", className, ...props }, ref) => {
  var _a;
